...
@section('title', "HotelExplorer :: Reviews")
...
<div class="container mt-4">
    <h2>{{ $hotel->nome ?? 'Hotel name not available' }}</h2>
    <p><strong>Location:</strong> {{ $hotel->localita ?? 'Location not available' }}</p>
    <p><strong>Description:</strong> {{ $hotel->descrizione ?? 'No description available.' }}</p>
