...
function html_head($titolo) {
    $siteName = basename(dirname(__FILE__));
    $result = '  <head>';
    ...
    $result .= '    <link rel="stylesheet" href="http://' . $_SERVER['HTTP_HOST'] . '/PW_runningExample_2025.04.03/css/bootstrap.css">';
    $result .= '    <link rel="stylesheet" href="http://' . $_SERVER['HTTP_HOST'] . '/PW_runningExample_2025.04.03/css/style.css">';
    ...
    $result .= '    <script src="http://' . $_SERVER['HTTP_HOST'] . '/PW_runningExample_2025.04.03/js/bootstrap.min.js"></script>';
