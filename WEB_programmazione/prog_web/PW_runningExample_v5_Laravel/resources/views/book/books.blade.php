                ...
                <tbody>
                    @foreach ($books_list as $book)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="{{ route('book.edit',['book' => $book->getId()]) }}"><i class="bi bi-pencil-square"></i> Edit</a>
                            </td>
                            <td>
                                <a class="btn btn-danger" href="{{ route('book.destroy.confirm',['id' => $book->getId()]) }}"><i class="bi bi-trash"></i> Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
