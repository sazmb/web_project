...
<div class="container-fluid text-center">
    <div class="row">
        <div class="col-md-12">
            <header>
                <h1>
                    Delete author "{{ $author->getFirstName() }} {{ $author->getLastName() }}" from the list
                </h1>
            </header>
            <p class="confirm">
        ...
        <div class="col-md-6 order-md-2">
            <div class="card border-secondary">
                ...
                <div class="card-body">
                    ...
                    <form name="author.delete" method="post" action="{{ route('author.destroy', ['author' => $author->getId()]) }}">
                        @method('DELETE')
                        @csrf
        ...
        <div class="col-md-6 order-md-1">
            <div class="card border-secondary">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-secondary" href="{{ route('author.index') }}"><i class="bi bi-box-arrow-left"></i> Cancel</a>
                </div>
            </div>
        </div>
    </div>
