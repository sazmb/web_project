...
Route::post('/trans/toggle-tipo', [TransController::class, 'toggleTipo'])->name('trans.toggleTipo');
Route::delete('/trans/destroy-ajax', [TransController::class, 'destroyAjax'])->name('trans.destroyAjax');
