...
/**
 * Attenzione: le rotte di seguito sono state generate automaticamente non sono sicuro siano corrette
 */
Route::resource('matches', MatchModelController::class);

Route::post('/matches/join', [MatchModelController::class, 'joinByCode'])->name('matches.join');
Route::post('/matches/{match}/start', [MatchModelController::class, 'start'])->name('matches.start');
Route::post('/matches/{match}/approve/{user}', [MatchModelController::class, 'approvePlayer'])->name('matches.approve');
Route::get('/matches/{match}/countdown', [MatchModelController::class, 'countdown'])->name('matches.countdown');