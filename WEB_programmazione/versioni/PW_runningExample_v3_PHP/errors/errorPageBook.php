    ...
    <div class="container-fluid d-flex justify-content-end">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Book error page</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="col-md-12">
                <div class="card border-danger">
                    <div class='card-header'>
                        Illegal page access: wrong book ID has been used!
                    </div>
                    <div class='card-body'>
                        <p>Something <strong>wrong</strong> happened while accessing this page</p>
                        <p><a class="btn btn-danger" href="../books/books.php"><i class="bi bi-box-arrow-left"></i> Back to books
                                list</a></p>
                    </div>
                </div>
            </div>
