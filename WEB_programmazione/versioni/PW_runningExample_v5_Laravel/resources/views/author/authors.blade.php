                    ...
                    <tbody>
                        @foreach ($authors_list as $author)
                            <tr>
                                ...
                                <td><a class="btn btn-primary" href="{{ route('author.edit',['author' => $author->getId()]) }}"><i class="bi bi-pencil-square"></i> Edit</a></td>
                                @if(!$author->hasBooks)
                                    <td><a class="btn btn-danger" href="{{ route('author.destroy.confirm',['id' => $author->getId()]) }}"><i class="bi bi-trash"></i> Delete</a></td>
                                @else
