...
@section('body')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                @if(isset($author))
                <form name="author" method="post" action="{{ route('author.update', ['author' => $author->getId()]) }}">
                ...
                @csrf
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-10">
                            @if(isset($author))
                                <input class="form-control" type="text" name="firstName" placeholder="Author's First Name" value="{{ $author->getFirstName() }}">
                            @else
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-10">
                            @if(isset($author))
                                <input class="form-control" type="text" name="lastName" placeholder="Author's Last Name" value="{{ $author->getLastName() }}">
                            @else
